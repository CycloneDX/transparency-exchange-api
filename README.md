...
- [TEA Artifacts](tea-collection/tea-collection.md#the-tea-artifact-object): Files associated with a Collection. A single TEA Artifact can appear in multiple Collections. Note that a TEA Artifact is a named term introduced by the TEA standard.
